...
- startup.sh:
  ...
  - Starts mongod bound to 0.0.0.0:27017 with inline config.
  ...
  - Writes db_connection.txt and db_visualizer/mongodb.env aligned to port 27017.

Healthcheck:
- healthcare_database/healthcheck.sh:
  - Primary: mongosh ping.
  - Fallback: TCP connect (/dev/tcp/127.0.0.1/27017) and 'ss -lnt' port check.
  - Usage: ./healthcheck.sh 27017
